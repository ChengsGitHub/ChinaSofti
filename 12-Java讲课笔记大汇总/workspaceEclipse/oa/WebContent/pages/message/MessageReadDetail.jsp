...
<div class="container">
  ...
  <div class="row" style="min-height:400px;"> 
    ...
    <input type="hidden" value="${message.MESSAGE_CONT }">
    <!--右侧内容-->
    <div class="span8">
      <h3>留言内容</h3>
      	<table class="table table-striped" width="500" border="0">
          <tr>
            <th width="139" scope="row">发件人姓名</th>
            <td>${message.EMP_NAME }</td>
          </tr>
          <tr>
            <th scope="row">收件时间</th>
        ...
        <p align="right"><a href="<%=request.getContextPath() %>/pages/message/ResponseMessage.jsp?rName=<my:encode value="${message.EMP_NAME }"/>&rId=${message.SEND_ID }" 
        	class="btn btn-large btn-block btn-primary">回复</a></p>
    </div>
  </div>
