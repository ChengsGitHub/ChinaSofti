...
<script type="text/javascript">
	...
	function del(mesId) {
		...
		if (bool) {
			...
			location.href= "<%=request.getContextPath() %>/message/delete.action?messageId="+mesId+"&flag=2"
		}
	}
</script>
  ...
  <div class="row" style="min-height:400px;"> 
    ...
    <div class="span8">
      ...
      <table class="table table-striped">
              <tr>
                <th><a href="<%=request.getContextPath() %>/message/queryNoSend.action?flag2=1">留言编号</a></th>
                <th><a href="<%=request.getContextPath() %>/message/queryNoSend.action?flag2=3">收件人id</a></th>
                <th><a href="<%=request.getContextPath() %>/message/queryNoSend.action?flag2=3">收件人姓名</a></th>
                <th><a href="<%=request.getContextPath() %>/message/queryNoSend.action">创建时间</a></th>
                <th>操作</th>
              </tr>
                ...
                <td>               	
                	<div class="btn-group">	                		
				        ...
				        <ul class="dropdown-menu">
				            <li><a href="<%=request.getContextPath() %>/message/readMySend.action?messageId=${message.MESSAGE_ID }&flag1=2"><font color="#000000">查看详细</font></a></li>
