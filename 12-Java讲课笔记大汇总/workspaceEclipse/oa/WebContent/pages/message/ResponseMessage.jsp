...
<script type="text/javascript">
	$(document).ready(function(e) {
		...
		$('#sendNewBtn').click(function(e) {
            $('#form1').attr('action','<%=request.getContextPath() %>/message/sendNew.action');
			$('#form1').submit();
        });
		
		//增加数据
		$('#insertBtn').click(function(e) {
            $('#form1').attr('action','<%=request.getContextPath() %>/message/insert.action');
			$('#form1').submit();
        });
...
<div class="container">
  ...
  <ul class="breadcrumb">
    ...
    <li><a href="#"><font color="#000000">收件箱</font></a><span class="divider">/</span></li>
    <li><a href="#"><font color="#000000">留言详情</font></a><span class="divider">/</span></li>
       ...
       <form id ="form1" name="form1" method="post">
	       <table width="500" border="0" align="center" class="table">
	          <tr>
	      	   <td>收件人</td>
	      	   <td>
	      	    <input type="text" name="recevName" value ="待回复人" readonly>
	      	    <input type="hidden" name="sendId" id="sendId" value ="${emp1Id}" >
	            <input type="hidden" name="recevId" id="recevId" value="${param.rId }">
	           </td>
	   	      </tr>
