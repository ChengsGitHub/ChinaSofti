...
<script type="text/javascript">
	...
	function returnPopValue() {		
		...
		$(window.parent.document).find('#recevId').val(emp1Id);
		$(window.parent.document).find('#recevName').val(emp1Name);	
	...
	$(document).ready(function(){
		$('input[name="ids"]').click(function(){
			emp1Id = $.trim( $(this).parent().parent().find('td').eq(1).text() );
			emp1Name = $.trim( $(this).parent().parent().find('td').eq(2).text() );			
		});		
	});
</script>
</head>
