...
<script type="text/javascript">
	...
	function del(mesId) {
		...
		if (bool) {
			...
			location.href= "<%=request.getContextPath() %>/message/delete.action?messageId="+mesId+"&flag=5"
		}
	}
</script>
  ...
  <div class="row" style="min-height:400px;"> 
    ...
    <div class="span8">
      ...
      <table class="table table-striped">
              <tr>
                <th>留言编号</th>
                <th><a href="<%=request.getContextPath() %>/message/queryNoRead.action?flag2=3">发件人id</a></th>
                <th><a href="<%=request.getContextPath() %>/message/queryNoRead.action?flag2=3">发件人姓名</a></th>
                <th><a href="<%=request.getContextPath() %>/message/queryNoRead.action">收件时间</a></th>
                <th>操作</th>
              </tr>
