				  ...
				  <a href="#addbus" class="btn btn-primary" id="addBusBtn" data-toggle="modal">增加</a>
					  ...
					  <div class="modal hide fade" id="addbus" data-backdrop="static" aria-hidden="true">
						 ...
						 <div class="modal-body">
							  <form class="form-horizontal" name="formadd" id="formadd" method="post" action="<%=request.getContextPath()%>/bus/insert.action" enctype="multipart/form-data">
					...
					<!--模态对话框内容  data-backdrop="static"表示用户点击黑色区域不会关闭对话框-->
					  <div class="modal hide fade" id="updatebus" data-backdrop="static" aria-hidden="true">
						 ...
						 <div class="modal-body">
							<form class="form-horizontal" name="formupdate" id="formupdate" method="post" action="<%=request.getContextPath()%>/bus/update.action" enctype="multipart/form-data">
								<div class="control-group">
