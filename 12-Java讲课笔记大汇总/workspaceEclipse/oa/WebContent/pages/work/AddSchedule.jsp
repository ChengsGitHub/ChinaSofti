	...
	$(document).ready(function(e) {
		...
		$('#form1').Validform({
			...
			callback:function(data){
				...
				setTimeout(function(){
					location.href="<%=request.getContextPath()%>/schedule/query.action?scheduleEmpid=${param.scheduleEmpid}";
				},2000);
...
<div class="container">
	...
	<div class="row">
	    ...
	    <div class="span8" style="min-height: 400px;">
	    	<h3>请填写新工作安排信息</h3>
              <form name="form1" id="form1" method="post" action="<%=request.getContextPath()%>/schedule/insert.action">
                <table width="100%" border="0" class="table table-striped">
                  <tr>
                    <td width="24%">工作安排编号</td>
                    <td width="76%"><input type="text" name="scheduleId" id="scheduleId" readonly></td>
                  </tr>
                  <tr>
                    <td>工作安排发起人</td>
                    <td><input type="text" name="scheduleEmpname" id="scheduleEmpname" value="${emp1Name }" readonly></td>
                  </tr>
                  <tr>
                    <td>工作安排</td>
                    <td><input type="text" name="scheduleSch" id="scheduleSch" datatype="s1-20" errormsg="工作安排必须是1到20个字符！"></td>
                  </tr>
                  <tr>
                    <td>所安排工作的起始时间</td>
                  ...
                  <tr>
                    <td>安排工作备注</td>
                    <td><textarea name="scheduleRem" rows="7" id="scheduleRem" style="width:100%;"></textarea></td>
                  </tr>
                </table>
               <input type="submit" value="保存工作安排" class="btn btn-primary btn-large">
                <input type="hidden" value="${param.scheduleEmpid}" name="scheduleEmpid">
          </form>
