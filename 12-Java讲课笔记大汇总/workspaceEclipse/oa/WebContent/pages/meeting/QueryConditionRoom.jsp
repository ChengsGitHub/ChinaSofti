...
<div class="container">
	...
	<div class="row">
	    ...
	    <div class="span8">
			...
			<form name="form1" id="form1" action="<%=request.getContextPath() %>/meetingroom/queryByCondition.action" method="get">
		...
		<!--  <input type="submit" value="增加" class="btn btn-primary btn-small" >-->
					...
					<div class="pagination pagination-centered">
						<ul>				
							<li ${pager.pageNum==1?'class="disabled"':''}><a href="?pageNum=1&roomName=${roomName}">首页</a></li>
							<li ${pager.pageNum==1?'class="disabled"':''}><a href="?pageNum=${pager.pageNum-1 }&roomName=${roomName}">上页</a></li>
							<c:forEach begin="1" end="${pager.pageCount }" var="i">		  			
							  	<li ${pager.pageNum==i?'class="disabled"':''}><a href="?pageNum=${i}&roomName=${roomName}">${i}</a></li> 		  			
							</c:forEach>		
							<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a href="?pageNum=${pager.pageNum+1 }&roomName=${roomName}">下页</a></li>
							<li ${pager.pageNum==pager.pageCount?'class="disabled"':''}><a href="?pageNum=${pager.pageCount}&roomName=${roomName}">末页</a></li>		
						</ul>
					</div>	
				</div>
