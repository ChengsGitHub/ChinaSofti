...
<body>
<form name="form1" id="form1" method="post" action="AddEmpServlet">
  <table class="table1" width="500" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td height="24" colspan="2" align="center" bgcolor="#00CCFF">请输入员工信息</td>
    </tr>
    <tr>
      <td width="121" height="24" align="center">员工姓名</td>
      <td width="379" height="24"><input datatype="*1-10" errormsg="姓名必须是1-10个字符" type="text" name="empName" id="empName"></td>
    </tr>
    <tr>
      <td height="24" align="center">邮箱地址</td>
      <td height="24"><input datatype="e" errormsg="这不是一个合法的邮箱"  type="text" name="empEmail" id="empEmail"></td>
    </tr>
    <tr>
      <td height="24" align="center">电话号码</td>
      <td height="24"><input datatype="m" errormsg="这不是一个合法的手机号码" type="text" name="empPhone" id="empPhone"></td>
    </tr>
    <tr>
      <td height="24" align="center">入职日期</td>
      <td height="24"><input datatype="*" errormsg="必须选择日期" type="text" name="empHiredate" id="empHiredate"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td height="24"><input datatype="n1-6" errormsg="工资必须是1-6位数字" type="text" name="empSalary" id="empSalary"></td>
    </tr>
    <tr>
